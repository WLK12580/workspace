...
: ${AMENT_CURRENT_PREFIX:="/home/wlk/workspace/autocar/install/src"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/src/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/src/environment/path.sh"
